...
describe('UserStatisticsService', () => {
  ...
  it('returns per-book daily reading rows and honours the days override', async () => {
    const rows = [
      { day: '2026-04-06', bookId: 2, bookTitle: 'Dune', readingSeconds: 600, sessionsCount: 2 },
      { day: '2026-04-07', bookId: 3, bookTitle: null, readingSeconds: 120, sessionsCount: 1 },
    ];
